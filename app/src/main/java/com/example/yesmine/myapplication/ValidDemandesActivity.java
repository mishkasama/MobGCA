...
public class ValidDemandesActivity extends AppCompatActivity {
   ...
   private validAdapter adapter;
    ...
    String json_url="http://10.0.2.2:18080/JEEPI-web/pi/demandes/validedemandes/2";
    String deleteurl="http://10.0.2.2:18080/JEEPI-web/pi/demandes/DeleteDemande/";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_valid_demandes);
        viewDemande();
    ...
    public void viewDemande()
    {
        ...
        adapter = new validAdapter(this, lst_Category);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View v,
                ...
                Volleydeletefunc();
                Toast.makeText(ValidDemandesActivity.this,"Demande  deleted successfully ", Toast.LENGTH_LONG).show();
                Intent i = new Intent(ValidDemandesActivity.this,MainActivity.class);
                startActivity(i);
